window.onload = () => {
  document.querySelector('#sidebar').innerHTML = `
    ...
    <nav class="flex-1 p-4 space-y-2">
      <a href="#" title="Home" class="block p-2 rounded hover:bg-gray-200 flex items-center space-x-2">
        <span>🏠</span><span>Home</span>
      </a>
      <a href="#" title="Products" class="block p-2 rounded hover:bg-gray-200 flex items-center space-x-2">
        <span>🏷️</span><span>Products</span>
      </a>
      <a href="#" title="Warehouses" class="block p-2 rounded hover:bg-gray-200 flex items-center space-x-2">
        <span>🏢</span><span>Warehouses</span>
      </a>
      <a href="#" title="Stock Management" class="block p-2 rounded hover:bg-gray-200 flex items-center space-x-2">
      ...
      <a href="#" title="Notifications" class="block p-2 rounded hover:bg-gray-200 flex items-center space-x-2">
        <span>🔔</span><span>Notifications</span>
        <span id="unread-sidebar-badge" class="ml-auto hidden bg-red-500 text-white text-xs px-2 py-0.5 rounded-full"></span>
      </a>
      <a href="#" title="Settings" class="block p-2 rounded hover:bg-gray-200 flex items-center space-x-2">
